package com.axonivy.utils.persistence.demo.tool.test.dao;
...
public class DemoDAO extends TestDAO implements BaseDAO {
	private static final String TESTDATA_RESOURCE_PATH = "/com/axonivy/utils/persistence/demo/tool/test/testdata/testdata.xlsx";
